    ...
    return (
        <div className="w-full">
            <div className="w-full flex justify-between items-center py-4 relative px-8">
                ...
                <div className="w-1/4 xl:w-1/5 text-start text-[15px] truncate">{employee.email}</div>
                <div className="w-1/5 xl:w-1/6 text-start text-[15px] truncate">{employee.phone}</div>
